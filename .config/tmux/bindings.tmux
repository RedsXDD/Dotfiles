...
bind-key O select-pane -t :.-    # Select the previous pane.
...
bind-key -n 'M-H'  swap-window -d -t -1 # Move active window to the left.
bind-key -n 'M-L' swap-window -d -t +1  # Move active window to the right.
