...
M.highlights_base = function (colors)
	return {
		...
		Terminal                  = { bg = colors.background, fg = colors.foreground },
		EndOfBuffer               = { fg = colors.background },
		Folded                    = { bg = colors.color0, fg = colors.foreground, bold = true },
		FoldColumn                = { link = "SignColumn" },
		ColorColumn               = { bg = colors.color0, fg = colors.foreground },
		...
		IncSearch                 = { bg = colors.color1, fg = colors.color0 },
		Search                    = { bg = colors.color2, fg = colors.color0 },
		...
		MiniStatuslineModeReplace  = { bg = colors.color3, fg = colors.background, bold = true },
		MiniStatuslineModeOther    = { link = "IncSearch", bold = true },
		...
		MiniStarterHeader     = { fg = colors.color4 },
		MiniStarterFooter     = { fg = colors.color5 },
