...
o.foldmethod = "marker"                     -- Set fold method.
...
o.listchars = require("user.icons").listchars -- Characters used for certain whitespace characters.
o.fillchars = require("user.icons").fillchars -- Characters to fill the statuslines, vertical separators and special lines in the window.
o.undolevels = 10000
