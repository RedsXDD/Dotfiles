return {
	...
	keys = function()
		...
		-- Main keymaps:
		pick_map("<Leader>fb", function()
			pick.builtin.buffers()
		end, "Search buffers.")
		pick_map("<Leader>ff", function()
			pick.builtin.files()
		end, "Find files on CWD.")
		pick_map("<Leader>fr", function()
			pick.builtin.resume()
		end, "Search resumes.")
		pick_map("<Leader>f?", function()
			pick.builtin.help()
		end, "Search help tags.")

		-- Extra keymaps:
		pick_map("<Leader>fc", function()
			extra.pickers.commands()
		end, "Search commands.")
		pick_map("<Leader>f/", function()
			extra.pickers.explorer()
		end, "Open file explorer.")
		pick_map("<Leader>fh", function()
			extra.pickers.history()
		end, "Search command history.")
		pick_map("<Leader>?", function()
			extra.pickers.keymaps()
		end, "Search keymaps.")
		pick_map("<Leader>fo", function()
			extra.pickers.oldfiles()
		end, "Search recently opened files.")
		pick_map("<Leader>fm", function()
			extra.pickers.marks()
		end, "Search marks.")
		pick_map("<Leader>fR", function()
			extra.pickers.registers()
		end, "Search registers.")
		pick_map("<Leader>fs", function()
			extra.pickers.spellsuggest()
		end, "Search spell suggestions.")

		-- Grep:
		pick_map("<Leader>fgg", function()
			pick.builtin.grep()
		end, "Grep for files on CWD.")
		pick_map("<Leader>fgl", function()
