...
o.listchars = require("core.icons").listchars -- Characters used for certain whitespace characters.
o.fillchars = require("core.icons").fillchars -- Characters to fill the statuslines, vertical separators and special lines in the window.
