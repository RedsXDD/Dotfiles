...
new_section(M.icons.actions.new_file, "New File", function()
	vim.cmd([[enew | startinsert]])
end)

new_section(M.icons.actions.quit, "Quit Neovim", function()
	vim.cmd([[qa!]])
end)

new_section(M.icons.actions.file_explorer, "Open File Explorer", function()
...
new_section(M.icons.actions.lazy, "Open Lazy.nvim", function()
	vim.cmd([[Lazy]])
end)

new_section(M.icons.actions.mason, "Open Mason", function()
	vim.cmd([[Mason]])
end)
